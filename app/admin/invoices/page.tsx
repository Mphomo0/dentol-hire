...
import { documentTotals, formatDate, DEFAULT_VAT, type VatConfig } from "@/lib/format";
import type { BusinessSettings, Invoice, InvoiceStatus, Rental } from "@/lib/types";
...
export default function InvoicesPage() {
  ...
  const vat: VatConfig = settings
    ? { enabled: settings.vatEnabled, rate: settings.vatRate }
    : DEFAULT_VAT;
